package com.robertocosta.userrequestspringbatch.reader;
...
import com.robertocosta.userrequestspringbatch.domain.ResponseUser;
...
public class FetchUserDataReaderConfig implements ItemReader<UserDTO> {
	...
	private List<UserDTO> fetchUserDataFromAPI() {
		...
		logger.info("[READER STEP] Requet uri: "+ String.format(uri, getPage(), pageSize));
	...
	@BeforeChunk
	public void beforeChunk(ChunkContext chuncContext) {
